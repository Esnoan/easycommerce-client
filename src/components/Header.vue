      ...
      <div class="navbar-container container-fluid">
          ...
          <li class="header-search">
            <div class="main-search morphsearch-search">
              <div class="input-group">
                ...
                <input type="text" class="form-control" placeholder="Inserte palabra clave">
        ...
        <ul class="nav-right" v-if="isLoggedIn">
              ...
              >
                ...
                <li>
                  <div class="media">
                    <img
                      class="img-radius"
                      src="../assets/avatar/avatar-4.jpg"
          ...
          <li class="user-profile header-notification">
            <div class="dropdown-primary dropdown">
              <div class="dropdown-toggle" data-toggle="dropdown">
                <img src="../assets/avatar/user.png" class="img-radius" alt="User-Profile-Image">
                <span>{{ getUser.first_names }}</span>
